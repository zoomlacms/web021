    ...
    <div class="tab-content">
        <div class="tab-pane active" id="water_div">
            <table class="table table-striped table-bordered tab-content">
                <tr>
                    <td class="td_l">是否开启水印：</td>
                    <td>
                        <input runat="server" type="checkbox" id="Isuse" class="switchChk"/></td>
                </tr>
                <tr><td>开启用户水印</td><td>
                    <input runat="server" type="checkbox" id="EnableUserWater" class="switchChk"/>
                                   </td></tr>
                <tr>
                    <td>传图水印：
                    </td>
                ...
                <tr>
                    <td class="style3"><%:lang.LF("文字大小") %>：<br />
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="input-group text_405">
                            <span class="input-group-addon">
                                <input type="radio" value="0" name="thumb_rad" checked="checked" /></span>
